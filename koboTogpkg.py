...
input_csv = "survey02.csv"
output13_gpkg = "output13_lines.gpkg"
layer_name = "troncons"  # name of the layer inside the GeoPackage

# Read CSV
df = pd.read_csv(input_csv, encoding="latin-1", sep=";")

column_name = "Capture de troncon"
...
# Save to GeoPackage
gdf.to_file(output13_gpkg, layer=layer_name, driver="GPKG")

print(f"GeoPackage created: {output13_gpkg}")
